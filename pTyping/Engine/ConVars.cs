...
namespace pTyping.Engine {
    public class ConVars {
        ...
        public static Bindable<float>  BackgroundDim = new(0.5f);
        public static Bindable<string> Username      = new("beyley");
        public static Bindable<string> Password = new(
        ...
        /// </summary>
        public static Bindable<int> BaseApproachTime = new(2000) {};
    }
}
